	...
	<div class="page-header">
	    <div class="row">
	    	...
	    	<div class="col-md-6 col-12" align="right">
	    		<a class="btn btn-success text-white" href="{{route('admin.page.index')}}">Back</a>
	    	</div>
	    </div>
	</div>
	<div class="card mt-2">
	      		...
	      		<div class="col-md-12 col-12">
	      			<div class="row">
	      				<div class="col-md-12 col-12">
					          ...
					          <div >
					            <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" placeholder="Enter page Title" value="{{ old('title') }}" required>
					                @error('title')
