...
@section('metas')
<title>Become a Tutor | Fly</title>
@endsection
...
@php
    ...
    $universities = User::whereRoleId(2)->whereStatus(1)->where('deleted_at',null)->get();
@endphp
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div class="single">
                    <span class="icon">
                        <img src="{{asset('frontend/images/market_price.svg')}}" />
                    </span>
                    <h5 class="title">Open Market Pricing</h5>
                    <p>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single">
                    ...
                    <p>
                        Check out what days drive the most traffic for yourself.
                    </p>
                </div>
            </div>
...
<section class="become_tutor_section">
    <div class="container">
        ...
        <form action="{{route('tutor-register')}}" method="POST" class="become_form">
            @csrf
            @method('POST')
            <div class="thumbnail">
                    ...
                    <div class="col-md-6 form-group px_10">
                        <select class="form-control" name="university_id">
                            ...
                            @foreach($universities as $univ)
                                <option value="{{$univ->id}}">{{$univ->full_name}}</option>
                            @endforeach
                        </select>
                        @error('university_id')
                            <span class="invalid-feedback" role="alert">
