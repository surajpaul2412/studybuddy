	...
	<div class="page-header">
	    <div class="row">
	    	...
	    	<div class="col-md-6 col-4" align="right">
	    		<a class="btn btn-info text-white" href="{{route('university.college.index')}}">Back</a>
	    	</div>
	    </div>
	</div>
	<div class="card mt-3">
    <div class="card-body">
      <form method="post" action="{{ route('university.college.update', $college->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
      	<div class="row">
