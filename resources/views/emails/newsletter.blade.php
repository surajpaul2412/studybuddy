...
<html lang="en">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    <title>Newsletter | studyBuddyFly</title>
     ...
     <table width="100%" height="100%" align="center" cellpadding="0" cellspacing="0" bgcolor="#f2f2f2">      
        <tr>
          <td bgcolor="#fff" style="padding: 0 ; text-align:center;" align="center" valign="top">                
            ...
            <tr>
              <td height="50" style="text-align:center; padding:20px 0 20px; border-bottom: 1px solid #ddd;" align="center"> <img src="http://127.0.0.1:8000/logo.jpg" /> </td>
            </tr>
          </table>    
            ...
            <tr>
              <td style="padding: 50px 25px; color:#000; font-size:12px; text-align: center;" bgcolor="#fff">                
                <p style="font-size: 22px; padding: 0 30px;"> Thanks for subscribing our newsletter</p><br />
